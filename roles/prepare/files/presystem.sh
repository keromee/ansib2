...
if [  ${OS_VERSION}  >= 7.2  ] 
then
	echo "system is rhel7.2 or later"
	fn_log "echo "system is rhel7.2 or later""
elif [ ${OS_VERSION} >= 7.2.1511   ]
then
	echo "system is CentOS7.2 or later"
	fn_log "echo "system is CentOS7.2 or later""	
else
